...
export class CoinsGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  async handleLocationUpdate(
    ...
    this.logger.log(`Location update: ${location.latitude}, ${location.longitude}`);
    ...
    const nearbyCoins = await this.coinsService.findNearbyCoins(location.latitude, location.longitude);
